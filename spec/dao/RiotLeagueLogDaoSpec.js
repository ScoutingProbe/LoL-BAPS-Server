describe("RiotLeagueLogDaoSpec", function(){
    ...
    //     let league_client = new RiotLeagueLogDao()
    //     league_client.stringPath = "C:/Users/andre/OneDrive/Documents/vscode-workspace/LoL-BAPS-Server/spec/dao"
    ...
    it("test RiotLeagueLogDao.isGameComplete", async function(){
        let league_client = new RiotLeagueLogDao()
        league_client.stringPath = "C:/Users/andre/OneDrive/Documents/vscode-workspace/LoL-BAPS-Server/spec/dao"
        league_client.stringFile = "gameComplete.log"
        const c = await league_client.isGameComplete()
