describe("LeagueClient", function(){
    ...
    //     let league_client = new LeagueClient()
    //     const expected = '2021-07-13T15-12-47_12100_LeagueClient.log'
    //     const actual = league_client.stringFile
    //     expect(expected).toEqual(actual)
    // })

    it("test LeagueClient.jsonSession dodge", async function(){
        let league_client = new LeagueClient()
        league_client.stringPath = "C:/Users/andre/Documents/vscode-workspace/lol-draft-ban-pick-scraper-server/spec/league"
    ...
    it("test LeagueClient.jsonSession session", async function(){
        let league_client = new LeagueClient()
        league_client.stringPath = "C:/Users/andre/Documents/vscode-workspace/lol-draft-ban-pick-scraper-server/spec/league"
    ...
    it("test LeagueClient.jsonSession readyCheck", async function(){
        let league_client = new LeagueClient()
        league_client.stringPath = "C:/Users/andre/Documents/vscode-workspace/lol-draft-ban-pick-scraper-server/spec/league"
